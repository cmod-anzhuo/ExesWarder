...
/**
 * 2010-8-12<br>
 * 处理1.5中CORE_POOL_SIZE为1导致执行堵塞问题
 * 
 * @mender ckcs
 * 
 * @param <Params>
...
public abstract class RunAsyncTask<Params, Progress, Result> {
	...
	private static final String LOG_TAG = "RunAsyncTask";
	...
	private static final ThreadFactory sThreadFactory = new ThreadFactory() {
		...
		public Thread newThread(Runnable r) {
			return new Thread(r, "ThreadTask->c #" + mCount.getAndIncrement());
		}
	};
			...
			protected void done() {
				...
				try {
					...
					message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
							new AsyncTaskResult<Result>(RunAsyncTask.this,
									(Result[]) null));
				...
				message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
						new AsyncTaskResult<Result>(RunAsyncTask.this, result));
				message.sendToTarget();
			}
		};
	}
	 ...
	 *             {@link RunAsyncTask.Status#RUNNING} or
	 *             {@link RunAsyncTask.Status#FINISHED}.
	 */
	public final RunAsyncTask<Params, Progress, Result> execute(
			Params... params) {
	...
	private static class AsyncTaskResult<Data> {
		@SuppressWarnings("unchecked")
		final RunAsyncTask mTask;
		final Data[] mData;

		@SuppressWarnings("unchecked")
		AsyncTaskResult(RunAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
